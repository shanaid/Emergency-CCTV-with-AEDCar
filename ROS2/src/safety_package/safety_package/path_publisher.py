...
class pathPub(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(Odometry, '/odom', self.listner_callback, 10)
        ...
        self.f = open('C:\\Users\\SSAFY\\Desktop\\catkin_ws\\src\\ssafy_bridge\\resource\\test.txt', 'r')
